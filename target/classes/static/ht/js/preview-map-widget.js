...
var CMS = function () {
    ...
    createClass(CMS, [{
        ...
        value: function initUI() {
            ...
            backBtn = this.backBtn = ht.Default.toCanvas('editor.undo', 32, 28, 'centerUniform', null, null, '#999'),
                editBtn = this.editBtn = ht.Default.toCanvas('editor.edit', 32, 28, 'centerUniform', null, null, '#000'),
                dm = gv.dm(),
                nodeAlarm = this.nodeAlarm = new NodeAlarm(dm, this, this.widgetId);
        ...
        value: function addListener() {
            ...
            gv.mi(function (e) {
                if (e.kind === 'clickData') {
                    var data = e.data;
                    if (!data.a('category')) return;
                    if (data.a('category') === 'MapWidget' && data.a('deviceName')) {
                        _this.loadMapWidget(parseInt(data.a('deviceName')));
                    } else if (data.a('deviceName')) {
                        window.open('/api/htbackend/openCMSViewer?devicename=' + data.a('deviceName'));
                    }
                }
            });
        }
            ...
            util.ajax({
                ...
                success: function success(r) {
                    ...
                    if (r && r[0] && r[0].content_data) {
                        ...
                        _this2.nodeAlarm.start(widgetId);
