...
var btnBgColor = '#fff';
/*
const mainPageId = parseInt(util.getUrlParamter('mainpageid'));
const colindex = parseInt(util.getUrlParamter('colindex'));
const rowindex = parseInt(util.getUrlParamter('rowindex'));
*/
...
var CMS = function () {
    ...
    createClass(CMS, [{
        ...
        value: function getOPMDeviceType() {
            var listForm = this.listForm;
            util.ajax({
                url: API_HEAD + 'getOPMDeviceType',
                type: 'get',
                success: function success(r) {
                    var combobox = listForm.getItemById('deviceType').element,
                        labels = ['All'],
                        values = ['all'];
                    for (var key in r) {
                        labels.push(r[key]);
        ...
        value: function initPropertyView() {
            ...
            this.gv.sm().ms(function () {
                ...
                if (ld instanceof ht.Edge) {
                    ...
                    setTimeout(function () {
                        if (_this3.propertyView._rows.get(1)) {
                            var property = _this3.propertyView._rows.get(1).property,
                                productId = ld.a('productId'),
                                imgs = _this3.productImgMap[productId];
        ...
        value: function initToolbar() {
            ...
            this.createToobarBtn({
                ...
                toolTip: 'Save & Preview MapWidget',
                onClicked: function onClicked() {
                    if (_this5.propertyForm.v('displayName') === 'undefined') {
                        ...
                        _this5.handleSaveMapWidget(function (r) {
                            ...
                            window.open('preview-map-widget.html?widget_id=' + (_this5.widgetId || r.id));
                        });
                    }
                }
            }),
