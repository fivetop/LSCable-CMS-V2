document.addEventListener('DOMContentLoaded',function(){
	...
	getWidgetDataAPI("InterfaceTrafficInPeriod", "192.168.0.51", callbackAPIInit);
	var series = [];	
	...
	function callbackAPIInit(data){
		...
		var chart = new Chartist.Line('#ct-chart', {
			...
			chart.on('draw', function(data) {
			  ...
			  if(data.type === 'line') {
			    ...
			    var pos1Animation = {
			      begin: seq * delays,
			      dur: durations,
			      from: data[data.axis.units.pos + '1'] - 15,
			    ...
			    var pos2Animation = {
			      begin: seq * delays,
			      dur: durations,
			      from: data[data.axis.units.pos + '2'] - 50,
			...
			chart.on('created', function() {
			  ...
			  window.__exampleAnimateTimeout = setTimeout(chart.update.bind(chart), 60000);
			});
